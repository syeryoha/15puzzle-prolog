	...
	(eSolucao(Nodo) ->
		...
		(
		 ...
		 (
		  write('Novo C: '),
		  write(C1), nl,
		  buscaIDA(ListaInicial, [], [], ListaInicial, C1, -1) % Se há um C, vamos começar tudo de novo com ele
		 )
		)
	      )
	    )
...
expandeFilhosIDA(Nodo, Lista, ListaR, C, C1) :-
	write('Entrei em expandeFilhos'), nl,
	...
	Fs1 = [NovoS1],concatsolIDA(Fs1,[NovoS2],Fs2),concatsolIDA(Fs2,[NovoS3],Fs3),concatsolIDA(Fs3,[NovoS4],Fs4),concatsolIDA(Fs4,Lista,ListaNO),ordena(ListaNO,ListaR).
